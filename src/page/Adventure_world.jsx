    ...
    <>
      ...
      <Page>
        ...
        <Right>
          ...
          {/* <MultiInstance src={ImageCommon.muiltInstance}></MultiInstance> */}
          <WorldInstance src={ImageCommon.worldInstance}></WorldInstance>
          <MobleAmount>
...
`
const WorldInstance = styled.img`
...
const AddBtn = styled.div`
  ...
  box-shadow: 0px ${autoWidthVW(3)} ${autoWidthVW(20)} 0px
    ...
    inset 0px 15px 18px 0px #b5e5ff;
  border-radius: ${autoWidthVW(20)};
...
const CheckWords = styled.div`
  ...
  line-height: ${autoWidthVW(17)};
`
export default Adventure_world
